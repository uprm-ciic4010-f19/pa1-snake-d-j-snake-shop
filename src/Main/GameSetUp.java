...
public class GameSetUp implements Runnable {
    ...
    private void init(){
        ...
        try {
            ...
            audioFile = getClass().getResourceAsStream("/music/CosasRaras.wav"); //Stranger Things Theme Song. We do not own the song, all rights to Netflix and The Duffer Bros.
